...
const std::string cCascadeName       = "/home/maxime/opencv_build/opencv/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml";
const std::string cNestedCascadeName = "/home/maxime/opencv_build/opencv/data/haarcascades/haarcascade_frontalcatface.xml";
...
int faceDetectionFromDefaultVideoStream(void) {
    ...
    nestedCascade.load(cCascadeName);

    // Change path before execution  
    cascade.load(cNestedCascadeName);
